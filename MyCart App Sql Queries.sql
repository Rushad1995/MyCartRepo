...
-- All product table
create table ProductList( prodId int(4) primary key, prodName varchar(25), prodCategory varchar(255),prodPrice varchar(10)) 
...
create table userCart ( prodId int(4) primary key, prodName varchar(25), prodCategory varchar(255),prodPrice varchar(10));
